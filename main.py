...
print('Please input filepath of geo.train as located on YOUR LOCAL MACHINE')
#path = input()
data_paths = "C:\\Users\\J\\Desktop\\SituatedQA"
output_dir = "C:\\Users\\J\\Desktop\\SituatedQA"
train_path = "C:\\Users\\J\\Desktop\\SituatedQA\\geo.train"
dev_path = "C:\\Users\\J\\Desktop\\SituatedQA\\geo.dev"

# Method to open the file and retrieve each of the document indexes in the Cran Corpus
def getData(data_paths, tokenizer):
    with open(data_paths, 'r', encoding='mac_roman') as f:
        all_data = []
        text = f.read().replace('\n'," ")
        lines = re.split(all_data, text)
        lines.pop(0)
    return BinClassDataset(all_data, tokenizer)

#end of my attempts 'coding'

#I don't really know how to work with .json files
